...
//Description   : This class represents Binary Tree
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
{
	private:
		struct nodeTree<T> *Head;

	public:
	    Tree();
	    void Insert(T);
	    void Inorder(struct nodeTree<T>*);
	    void Preorder(struct nodeTree<T>*);
	    void Postorder(struct nodeTree<T>*);
        int Count(struct nodeTree<T>*);
        BOOL Search(struct nodeTree<T>*, T);
};
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Class name    : Queue
...
template<typename T>
void Tree<T>::Inorder(struct nodeTree<T> *First)
		{
...
template<typename T>
void Tree<T>:: Preorder( struct nodeTree<T> *First)
		{
			static BOOL Flag=TRUE;
			if(Flag==TRUE)
			{
...
template<typename T>
void Tree<T>::Postorder(struct nodeTree<T> *First)
		{
			static BOOL Flag=TRUE;
			if(Flag==TRUE)
			{
...
template<typename T>
int Tree<T>::Count(struct nodeTree<T> *First)
		{
			static BOOL Flag=TRUE;
			static int iCnt=0;
			if(Flag==TRUE)
...
template<typename T>
BOOL Tree<T>::Search(struct nodeTree<T> *First,T iNo)
		{
			static BOOL Flag=TRUE;
			if(Flag==TRUE)
			{
...
//  Function Author :   Haridas Ramtirthe
//  Parameters      :   NONE
...
int main()
{
	...
	iRet2=obj.Count(NULL);
	cout<<iRet2;
	cout<<"\n";
	bRet2=obj.Search(NULL,1);
	if(bRet2==FALSE)
	{
